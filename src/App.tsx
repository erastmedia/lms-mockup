...
// import ForumPengumumanDetailPage from "./pages/ForumPengumumanDetailPage";
// import PresensiJurnalPage from "./pages/PresensiJurnalPage";
// import BukuNilaiAnalisisKdPage from "./pages/BukuNilaiAnalisisKdPage";
...
// import PortofolioRekapSiswaPage from "./pages/PortofolioRekapSiswaPage";
  ...
  return (
    <Routes>
      ...
      <Route path="/" element={<LmsLayout />}>
        ...
        <Route
          path="forum-pengumuman/:pengumumanId"
          element={<ForumPengumumanDetailPage />}
        /> */}
        ...
        />
        <Route
          path="portofolio-refleksi/:siswaId"
          element={<PortofolioRekapSiswaPage />}
        /> */}
